# TMUX with 24-bit color support.  Lifted from:
#
#   https://github.com/choppsv1/homebrew-term24
#
# I only need this, because tmux 2.2 has some issue on Mac OS X and they won't
# put it in homebrew.  Once 2.3 is out, this should work out of the box.
class Tmux < Formula
